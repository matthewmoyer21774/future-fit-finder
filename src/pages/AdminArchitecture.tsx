...
const pipelineNodes: PipelineNode[] = [
  ...
  },
  {
    ...
    description: "Anthropic Claude extracts structured profile: name, role, industry, skills, career goals",
  ...
  },
  {
    ...
    step: 6,
    label: "RAG Synthesis",
    tech: "Claude Sonnet 4 / GPT-5",
    description: "Claude Sonnet 4 (Railway) or GPT-5 (Cloud) generates personalised recommendations and outreach email",
