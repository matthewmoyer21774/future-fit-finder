...
const pipelineNodes: PipelineNode[] = [
  ...
  },
  {
    ...
    tech: "GPT-4o-mini",
    description: "Classifying career interests into programme categories",
  ...
  },
  {
    ...
    label: "RAG Synthesis",
    tech: "GPT-4o-mini",
    description: "Generating personalised recommendations and outreach email",
            ...
            <CardContent className="p-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {[
                  ...
                  { name: "GPT-4o-mini", role: "Zero-Shot Classification" },
